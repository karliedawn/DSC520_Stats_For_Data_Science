...
```{r}
person_df1 <- read.csv(file = 'DSC520/dsc520/data/tidynomicon/person.csv')
```
...
```{r}
person_df2 <- read.csv(file = 'DSC520/dsc520/data/tidynomicon/person.csv', stringsAsFactors = FALSE)
str(person_df2)
```
...
```{r}
scores_df <- read.csv(file = 'DSC520/dsc520/data/scores.csv')
summary(scores_df)
```
...
```{r}
excel_sheets("DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls")
```
...
```{r}
voter_turnout_df1 <- read_excel("DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 1)
...
voter_turnout_df2 <- read_excel("DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", col_names = column_names,  skip = 2)
...
```{r}
db <- dbConnect(RSQLite::SQLite(), "DSC520/dsc520/data/tidynomicon/example.db")
```
